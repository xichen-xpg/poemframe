...
function createPrompt(selectedPoem) {
  ...
  return `
帮我给这首古诗文生成一张 800x480 的白底古风设计感海报。在海报上原样显示下方提供的日期文字，不要改写也不要自行推断。风格典雅克制，极简高级，整体避免极细线条。标题竖排，正文字要大一点。海报上必需包含白话文译文（必备，不可省略），译文长度不超过 60 个汉字，只要能传达正文主旨大意即可，不要逐句翻译。译文文字应明显小于正文，放在正文下方，确保不超出画布。
