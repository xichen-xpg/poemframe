...
function createPrompt(selectedPoem) {
  ...
  return `
帮我给这首古诗文及其译文生成一张 800x480 的白底古风诗词海报，用在 7 寸墨水屏上。标题竖排显示。字要大一点，正文要清楚易读，文字是画面重点。画面简洁，留白多一点。避免过细字体、过细线条和低对比装饰，黑白灰阶显示也要清楚。如果正文字数不超过80字，必须加入简短现代文译文；如果正文字数超过80字，就不要译文。
